...
public class MessageRepository(DataContext context, IMapper mapper) : IMessageRepository
{
    ...
    public async Task<Connection?> GetConnection(string conneectionId)
    {
        return await context.Connections.FindAsync(conneectionId);
    }
    ...
    public async Task<Message?> GetMessage(int id) => await context.Messages.FindAsync(id);
